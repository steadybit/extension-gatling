...
| `$ make container` | Build the container image (`extension-gatling:latest`) using Docker buildx.                           |
...
## Releasing Helm Chart Changes
 ...
 1. Update the version number in the [Chart.yaml](./charts/steadybit-extension-gatling/Chart.yaml)
...
```
> Releasing charts...
    Error: error creating GitHub release steadybit-extension-gatling-1.0.0: POST https://api.github.com/repos/steadybit/extension-gatling/releases: 422 Validation Failed [{Resource:Release Field:tag_name Code:already_exists Message:}]
```
